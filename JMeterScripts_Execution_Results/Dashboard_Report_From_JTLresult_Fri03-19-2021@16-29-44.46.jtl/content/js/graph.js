...
var responseTimeDistributionInfos = {
        data: {"result": {"minY": 55053.0, "minX": 0.0, "maxY": 55053.0, "series": [{"data": [[0.0, 55053.0]], "isOverall": false, "label": "GetRequest_SingleUser_10.1.20.7", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 100, "maxX": 4.9E-324, "title": "Response Time Distribution"}},
        getOptions: function() {
...
var syntheticResponseTimeDistributionInfos = {
        data: {"result": {"minY": 55053.0, "minX": 3.0, "ticks": [[0, "Requests having \nresponse time <= 500ms"], [1, "Requests having \nresponse time > 500ms and <= 1,500ms"], [2, "Requests having \nresponse time > 1,500ms"], [3, "Requests in error"]], "maxY": 55053.0, "series": [{"data": [], "color": "#9ACD32", "isOverall": false, "label": "Requests having \nresponse time <= 500ms", "isController": false}, {"data": [], "color": "yellow", "isOverall": false, "label": "Requests having \nresponse time > 500ms and <= 1,500ms", "isController": false}, {"data": [], "color": "orange", "isOverall": false, "label": "Requests having \nresponse time > 1,500ms", "isController": false}, {"data": [[3.0, 55053.0]], "color": "#FF6347", "isOverall": false, "label": "Requests in error", "isController": false}], "supportsControllersDiscrimination": false, "maxX": 3.0, "title": "Synthetic Response Times Distribution"}},
        getOptions: function() {
            return {
                legend: {
                    noColumns: 2,
...
var activeThreadsOverTimeInfos = {
        data: {"result": {"minY": 2.7315382867530045, "minX": 1.61617134E12, "maxY": 2.7802642105035558, "series": [{"data": [[1.6161714E12, 2.7802642105035558], [1.61617134E12, 2.7315382867530045]], "isOverall": false, "label": "10.1.20.7-TG2", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.6161714E12, "title": "Active Threads Over Time"}},
        getOptions: function() {
            return {
                series: {
                    stack: true,
...
var timeVsThreadsInfos = {
        data: {"result": {"minY": 0.0, "minX": 1.0, "maxY": 8.483563096500516E-4, "series": [{"data": [[2.0, 8.483563096500516E-4], [4.0, 1.8723786698621956E-4], [1.0, 0.0], [3.0, 4.873294346978556E-5]], "isOverall": false, "label": "GetRequest_SingleUser_10.1.20.7", "isController": false}, {"data": [[3.286287759068551, 1.816431438795345E-4]], "isOverall": false, "label": "GetRequest_SingleUser_10.1.20.7-Aggregated", "isController": false}], "supportsControllersDiscrimination": true, "maxX": 4.0, "title": "Time VS Threads"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var bytesThroughputOverTimeInfos = {
        data : {"result": {"minY": 0.0, "minX": 1.61617134E12, "maxY": 869518.8, "series": [{"data": [[1.6161714E12, 869518.8], [1.61617134E12, 165477.6]], "isOverall": false, "label": "Bytes received per second", "isController": false}, {"data": [[1.6161714E12, 0.0], [1.61617134E12, 0.0]], "isOverall": false, "label": "Bytes sent per second", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.6161714E12, "title": "Bytes Throughput Over Time"}},
        getOptions : function(){
            return {
                series: {
                    lines: {
...
var responseTimesOverTimeInfos = {
        data: {"result": {"minY": 1.2972692482324588E-4, "minX": 1.61617134E12, "maxY": 4.5444217223358373E-4, "series": [{"data": [[1.6161714E12, 1.2972692482324588E-4], [1.61617134E12, 4.5444217223358373E-4]], "isOverall": false, "label": "GetRequest_SingleUser_10.1.20.7", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.6161714E12, "title": "Response Time Over Time"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
...
var latenciesOverTimeInfos = {
        data: {"result": {"minY": 0.0, "minX": 1.61617134E12, "maxY": 4.9E-324, "series": [{"data": [[1.6161714E12, 0.0], [1.61617134E12, 0.0]], "isOverall": false, "label": "GetRequest_SingleUser_10.1.20.7", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.6161714E12, "title": "Latencies Over Time"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var connectTimeOverTimeInfos = {
        data: {"result": {"minY": 0.0, "minX": 1.61617134E12, "maxY": 4.9E-324, "series": [{"data": [[1.6161714E12, 0.0], [1.61617134E12, 0.0]], "isOverall": false, "label": "GetRequest_SingleUser_10.1.20.7", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.6161714E12, "title": "Connect Time Over Time"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var responseTimeVsRequestInfos = {
    data: {"result": {"minY": 0.0, "minX": 101.0, "maxY": 4.9E-324, "series": [{"data": [[2105.0, 0.0], [2069.0, 0.0], [2130.0, 0.0], [654.0, 0.0], [166.0, 0.0], [2823.0, 0.0], [3181.0, 0.0], [3577.0, 0.0], [3617.0, 0.0], [3887.0, 0.0], [4001.0, 0.0], [4225.0, 0.0], [4280.0, 0.0], [4313.0, 0.0], [4296.0, 0.0], [1284.0, 0.0], [394.0, 0.0], [101.0, 0.0], [1786.0, 0.0], [1799.0, 0.0], [465.0, 0.0], [1900.0, 0.0], [2000.0, 0.0]], "isOverall": false, "label": "Failures", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 1000, "maxX": 4313.0, "title": "Response Time Vs Request"}},
    getOptions: function() {
        return {
            series: {
                lines: {
...
var latenciesVsRequestInfos = {
    data: {"result": {"minY": 0.0, "minX": 101.0, "maxY": 4.9E-324, "series": [{"data": [[2105.0, 0.0], [2069.0, 0.0], [2130.0, 0.0], [654.0, 0.0], [166.0, 0.0], [2823.0, 0.0], [3181.0, 0.0], [3577.0, 0.0], [3617.0, 0.0], [3887.0, 0.0], [4001.0, 0.0], [4225.0, 0.0], [4280.0, 0.0], [4313.0, 0.0], [4296.0, 0.0], [1284.0, 0.0], [394.0, 0.0], [101.0, 0.0], [1786.0, 0.0], [1799.0, 0.0], [465.0, 0.0], [1900.0, 0.0], [2000.0, 0.0]], "isOverall": false, "label": "Failures", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 1000, "maxX": 4313.0, "title": "Latencies Vs Request"}},
    getOptions: function() {
        return{
            series: {
                lines: {
...
var hitsPerSecondInfos = {
        data: {"result": {"minY": 146.7, "minX": 1.61617134E12, "maxY": 770.85, "series": [{"data": [[1.6161714E12, 770.85], [1.61617134E12, 146.7]], "isOverall": false, "label": "hitsPerSecond", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.6161714E12, "title": "Hits Per Second"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var codesPerSecondInfos = {
        data: {"result": {"minY": 146.7, "minX": 1.61617134E12, "maxY": 770.85, "series": [{"data": [[1.6161714E12, 770.85], [1.61617134E12, 146.7]], "isOverall": false, "label": "Non HTTP response code: java.net.URISyntaxException", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.6161714E12, "title": "Codes Per Second"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
...
var transactionsPerSecondInfos = {
        data: {"result": {"minY": 146.7, "minX": 1.61617134E12, "maxY": 770.85, "series": [{"data": [[1.6161714E12, 770.85], [1.61617134E12, 146.7]], "isOverall": false, "label": "GetRequest_SingleUser_10.1.20.7-failure", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.6161714E12, "title": "Transactions Per Second"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
...
var totalTPSInfos = {
        data: {"result": {"minY": 146.7, "minX": 1.61617134E12, "maxY": 770.85, "series": [{"data": [], "isOverall": false, "label": "Transaction-success", "isController": false}, {"data": [[1.6161714E12, 770.85], [1.61617134E12, 146.7]], "isOverall": false, "label": "Transaction-failure", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.6161714E12, "title": "Total Transactions Per Second"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
